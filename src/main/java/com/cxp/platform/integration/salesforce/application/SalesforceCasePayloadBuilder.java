...
public class SalesforceCasePayloadBuilder {

    private final JdbcTemplate jdbcTemplate;

    public Map<String, Object> buildPayload(Complaint complaint) {
        String governingBodyCode = findCodeById("governing_body", complaint.getGoverningBodyId());

        Map<String, Object> wardInfo = findWardCodeAndZone(complaint.getWardId());
        ...
        String departmentCode = complaint.getDepartment();
        String departmentUnitCode = null;

        Map<String, Object> payload = new HashMap<>();
        payload.put("Subject", complaint.getTitle());
        payload.put("Description", complaint.getDescription());
        payload.put("Origin", "CIRM");
        ...
        payload.put("Department_Unit__r", relationByCode(departmentUnitCode));
