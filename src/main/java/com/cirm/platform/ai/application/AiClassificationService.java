...
import com.cirm.platform.ai.port.AiClient;
...
public class AiClassificationService {
    ...
    /**
     * Sends service request text to AI service and returns classification result.
     */
    ...
    /**
     * Compatibility method for legacy complaint creation flows.
     */
    public AiClassificationResponse classifyComplaint(String complaintText) {
        return classifyServiceRequest(complaintText);
    }
}
